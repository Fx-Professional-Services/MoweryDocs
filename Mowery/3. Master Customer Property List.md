...
- 👤 [Customer Detail View](#-customer-detail-view)  
  ...
  - 💰[COD Only (Cash on Delivery)](#-cod-only-cash-on-delivery)  
    - 🏷️ [Mark a customer as COD](#-mark-a-customer-as-cod)  
    - ✍️ [Service call for a COD customer](#-service-call-for-a-cod-customer)  
...
#### ✍️ Service call for a COD customer
