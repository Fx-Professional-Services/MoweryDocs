...
The **System Defaults** section centralizes key configuration tools for the Mowery system. Use this section to:

- Create and manage product **catalogs** (also called price books), including pricing and tax settings.
    
- Maintain **product pricing** and review historical pricing changes.
...
- [Catalog Management](#catalog-management)  
  - [Catalog Generation for Multi-Category Products](#catalog-generation-for-multi-category-products)  
...
- [Products](#products)  
  - [Managing Product Pricing](#managing-product-pricing)  
...
- [FileMaker Access](#filemaker-access)  
  ...
  - [Delete from FileMaker Access](#delete-from-filemaker-access)  
  - [Archive vs Delete](#-archive-vs-delete)  
  - [Confirmation Dialogs](#-confirmation-dialogs)  
  - [What Happens After Archiving](#-what-happens-after-archiving)  
...
Catalogs (also called **price books**) define product pricing effective on a given date. The system supports duplication, searching, reordering, and multi-category products to ensure accuracy and flexibility.

---
## Catalog Generation for Multi-Category Products

Catalogs now support products assigned to **multiple categories and types**. Each product appears in all relevant sections of the catalog.

> 📌 This update may require product table adjustments to support multi-category and type associations.
...
6. Review the success or failure message.
    
7. Select the catalog name to open it.
    
8. Verify that the number of catalog items matches your active product list.
    

> **Note:** In Mowery, **Catalog** and **Price Book** are interchangeable.
...
- Must be unique (cannot duplicate an existing catalog date).
    
- Applies automatically to all catalog items.
    
- Updating the effective date updates all catalog items.
...
Duplicating a catalog keeps all **manual edits** (e.g., custom prices, descriptions).
...
6. Open the duplicated catalog.
    
7. Verify that item counts match the original.
    
8. Confirm your manual edits were preserved.
    

> **Tip:** If edits are lost, contact your system administrator.
...
> ⚠️ **Warning:** Deleting a catalog is permanent and cannot be undone.
...
<p style="float: right; margin-left: 15px; width: 20%;">
  <img src="https://github.com/Fx-Professional-Services/MoweryDocs/blob/staging/Mowery/Mowery%20User%20Guide/Images/delete_account.png" alt="Click X to Delete an Employee" style="width: 75%;" />

</p>


<p style="text-align: center; font-style: italic;"> Confirmation dialog when you click <b>(X)</b> to delete an employee. </p> <p style="float: right; margin-left: 15px; width: 20%;">
  <img src="https://github.com/Fx-Professional-Services/MoweryDocs/blob/staging/Mowery/Mowery%20User%20Guide/Images/archive_account.png" alt="Click Archive Account" style="width: 75%;" />

</p>


<p style="text-align: center; font-style: italic;"> Confirmation dialog when you click <b>Archive Account</b>. </p>
