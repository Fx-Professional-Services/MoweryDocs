...
- [Catalog Management](#catalog-management)  
  ...
  - [Print a Catalog](#print-a-catalog)  
...
   - For a new catalog, follow the steps above in creating a catalog..
...
6. If everything looks correct, use your system’s print dialog to print or export to PDF.
### ✅ Expected Result
...
<p align="center"> <img src="https://github.com/Fx-Professional-Services/MoweryDocs/blob/id_1301/Mowery/Mowery%20User%20Guide/Images/delete_account.png" width="70%"/> </p> <p style="text-align: center; font-style: italic;"> Confirmation dialog when you click <b>(X)</b> to delete an employee. </p> <p align="center"> <img src="https://github.com/Fx-Professional-Services/MoweryDocs/blob/id_1301/Mowery/Mowery%20User%20Guide/Images/archive_account.png" alt="Archive account confirmation dialog" width="70%"/> </p> <p style="text-align: center; font-style: italic;"> Confirmation dialog when you click <b>Archive Account</b>. </p>

_____

### 📌 What Happens After Archiving

- Archiving removes or deactivates FileMaker account access but does **not** delete the employee record.
    
- The employee record remains visible for administrative purposes or potential reactivation.
    
- Historical records—such as service calls, dispatch logs, and customer visits—continue to display the employee’s name.
    
- Past records are preserved so names remain visible, even when accounts are removed.
